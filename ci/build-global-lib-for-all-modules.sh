...
mvn -s git-repo-all-out/ci/settings.xml -f git-repo-all-out/global-lib-for-all-modules/pom.xml versions:set -DnewVersion=$NEW_VERSION -DgenerateBackupPoms=false -DoldVersion='*'
echo "Building global-lib-for-all-modules module..."
mvn -s git-repo-all-out/ci/settings.xml -f git-repo-all-out/global-lib-for-all-modules/pom.xml clean install
echo "Moving jar to output folder..."
mv git-repo-all-out/global-lib-for-all-modules/target/*.jar global-output/
echo "Cleaning..."
mvn -s git-repo-all-out/ci/settings.xml -f git-repo-all-out/global-lib-for-all-modules/pom.xml clean
